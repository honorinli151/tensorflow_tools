'''
File: d:\MyProjects\tensorflow_tools\object_detection_evaluation.py
...
from tensorflow_tools.F_score import F_Score
...
class ObjectDetectionEvaluation(object):
  ...
  def evaluate(self):
    ...
    for class_index in range(self.num_class):
      ...
      F2_Score_per_class = F_score(precision, recall, 2)
      self.precisions_per_class.append(precision)
      self.recalls_per_class.append(recall)
      F2_Score.append(F2_Score_per_class)
